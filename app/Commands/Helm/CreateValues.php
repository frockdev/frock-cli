...
class CreateValues extends Command
{
    ...
    public function handle(Config $config)
    {
        ...
        file_put_contents($config->getDeployConfig()->valuesByEnv . "/values.yaml", '# this file is autogenerated, do not edit it manually');
        ...
        file_put_contents($config->getDeployConfig()->valuesByEnv . "/.gitignore", "values.yaml".PHP_EOL, FILE_APPEND);
    }
